...
package ada_main is
   ...
   u00001 : constant Version_32 := 16#d7a56fd8#;
   ...
   u00099 : constant Version_32 := 16#91613c5c#;
   pragma Export (C, u00099, "ada__real_timeB");
   u00100 : constant Version_32 := 16#87ade2f4#;
   pragma Export (C, u00100, "ada__real_timeS");
   u00101 : constant Version_32 := 16#1f99af62#;
   pragma Export (C, u00101, "system__arith_64B");
   u00102 : constant Version_32 := 16#d4b08bf7#;
   pragma Export (C, u00102, "system__arith_64S");
   u00103 : constant Version_32 := 16#30bb6e97#;
   pragma Export (C, u00103, "system__taskingB");
   u00104 : constant Version_32 := 16#8d6ada58#;
   pragma Export (C, u00104, "system__taskingS");
   u00105 : constant Version_32 := 16#01715bc2#;
   pragma Export (C, u00105, "system__task_primitivesS");
   u00106 : constant Version_32 := 16#f4bb5b54#;
   pragma Export (C, u00106, "system__os_interfaceS");
   u00107 : constant Version_32 := 16#2c7d263c#;
   pragma Export (C, u00107, "interfaces__c__stringsB");
   u00108 : constant Version_32 := 16#603c1c44#;
   pragma Export (C, u00108, "interfaces__c__stringsS");
   u00109 : constant Version_32 := 16#1716ff24#;
   pragma Export (C, u00109, "system__win32S");
   u00110 : constant Version_32 := 16#e2725713#;
   pragma Export (C, u00110, "system__task_primitives__operationsB");
   u00111 : constant Version_32 := 16#12291044#;
   ...
   u00113 : constant Version_32 := 16#1432cf06#;
   pragma Export (C, u00113, "system__float_controlS");
   u00114 : constant Version_32 := 16#da8ccc08#;
   pragma Export (C, u00114, "system__interrupt_managementB");
   u00115 : constant Version_32 := 16#c90ea50e#;
   pragma Export (C, u00115, "system__interrupt_managementS");
   u00116 : constant Version_32 := 16#f65595cf#;
   pragma Export (C, u00116, "system__multiprocessorsB");
   u00117 : constant Version_32 := 16#cc621349#;
   pragma Export (C, u00117, "system__multiprocessorsS");
   u00118 : constant Version_32 := 16#f4bb3578#;
   pragma Export (C, u00118, "system__os_primitivesB");
   u00119 : constant Version_32 := 16#441f0013#;
   pragma Export (C, u00119, "system__os_primitivesS");
   u00120 : constant Version_32 := 16#0881bbf8#;
   pragma Export (C, u00120, "system__task_lockB");
   u00121 : constant Version_32 := 16#9544bb54#;
   pragma Export (C, u00121, "system__task_lockS");
   u00122 : constant Version_32 := 16#1a9147da#;
   pragma Export (C, u00122, "system__win32__extS");
   u00123 : constant Version_32 := 16#77769007#;
   pragma Export (C, u00123, "system__task_infoB");
   u00124 : constant Version_32 := 16#232885cd#;
   pragma Export (C, u00124, "system__task_infoS");
   u00125 : constant Version_32 := 16#ab9ad34e#;
   pragma Export (C, u00125, "system__tasking__debugB");
   u00126 : constant Version_32 := 16#f1f2435f#;
   pragma Export (C, u00126, "system__tasking__debugS");
   u00127 : constant Version_32 := 16#fd83e873#;
   pragma Export (C, u00127, "system__concat_2B");
   u00128 : constant Version_32 := 16#f66e5bea#;
   pragma Export (C, u00128, "system__concat_2S");
   u00129 : constant Version_32 := 16#2b70b149#;
   pragma Export (C, u00129, "system__concat_3B");
   u00130 : constant Version_32 := 16#ffbed09f#;
   pragma Export (C, u00130, "system__concat_3S");
   u00131 : constant Version_32 := 16#d0432c8d#;
   pragma Export (C, u00131, "system__img_enum_newB");
   u00132 : constant Version_32 := 16#95828afa#;
   pragma Export (C, u00132, "system__img_enum_newS");
   u00133 : constant Version_32 := 16#118e865d#;
   pragma Export (C, u00133, "system__stack_usageB");
   u00134 : constant Version_32 := 16#00bc3311#;
   pragma Export (C, u00134, "system__stack_usageS");
   u00135 : constant Version_32 := 16#d7aac20c#;
   pragma Export (C, u00135, "system__ioB");
   u00136 : constant Version_32 := 16#6a8c7b75#;
   pragma Export (C, u00136, "system__ioS");
   u00137 : constant Version_32 := 16#216aa6ef#;
   pragma Export (C, u00137, "system__random_numbersB");
   u00138 : constant Version_32 := 16#0d50ccf7#;
   ...
   u00141 : constant Version_32 := 16#7cd2c459#;
   pragma Export (C, u00141, "system__random_seedB");
   u00142 : constant Version_32 := 16#95585536#;
   pragma Export (C, u00142, "system__random_seedS");
   u00143 : constant Version_32 := 16#649a98f6#;
   pragma Export (C, u00143, "ada__calendarB");
   u00144 : constant Version_32 := 16#e67a5d0a#;
   pragma Export (C, u00144, "ada__calendarS");
   u00145 : constant Version_32 := 16#d6fbdf05#;
   pragma Export (C, u00145, "system__tasking__stagesB");
   u00146 : constant Version_32 := 16#f8a082a4#;
   pragma Export (C, u00146, "system__tasking__stagesS");
   u00147 : constant Version_32 := 16#57a37a42#;
   pragma Export (C, u00147, "system__address_imageB");
   u00148 : constant Version_32 := 16#55221100#;
   pragma Export (C, u00148, "system__address_imageS");
   u00149 : constant Version_32 := 16#100eaf58#;
   pragma Export (C, u00149, "system__restrictionsB");
   u00150 : constant Version_32 := 16#efa60774#;
   pragma Export (C, u00150, "system__restrictionsS");
   u00151 : constant Version_32 := 16#92d5df45#;
   pragma Export (C, u00151, "system__tasking__initializationB");
   u00152 : constant Version_32 := 16#d9930fa8#;
   pragma Export (C, u00152, "system__tasking__initializationS");
   u00153 : constant Version_32 := 16#001f972c#;
   pragma Export (C, u00153, "system__soft_links__taskingB");
   u00154 : constant Version_32 := 16#e47ef8be#;
   ...
   u00176 : constant Version_32 := 16#3fb127e5#;
   pragma Export (C, u00176, "system__traces__taskingS");
   u00177 : constant Version_32 := 16#2bce1226#;
   pragma Export (C, u00177, "system__memoryB");
   u00178 : constant Version_32 := 16#adb3ea0e#;
